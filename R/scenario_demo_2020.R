...
#' * `smsp` (double): Sector market share percentage of the pathway calculated in 2020.
#' * `technology` (character): The technology within the sector to which the scenario prescribes a pathway.
#' * `tmsr` (double): Technology market share ratio of the pathway calculated in 2020.
