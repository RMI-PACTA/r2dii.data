...
# set up project----
input_path_abcd <- file.path("/Users/jdhoffa/Library/CloudStorage/OneDrive-RMI/Documents/test_demo_data.csv")
...
loanbook_sample %>%
  readr::write_csv("/Users/jdhoffa/Library/CloudStorage/OneDrive-RMI/Documents/test_loanbook_demo_data.csv")
