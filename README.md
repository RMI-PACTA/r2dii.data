...
This package provides public datasets to help you learn and use R to
study how financial assets align to climate scenarios; it supports the
implementation in R of the software ‘PACTA’ (Paris Agreement Capital
Transition Assessment; <https://2degrees-investing.org/>).
